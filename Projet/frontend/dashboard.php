...
<body>
    <main>
        ...
        <section class="dashboard">
            <h2 class="dashboard__subtitle">Mesurez ici vos consommations hebdomadaires des nutriments majeurs au bon développement de votre corps</h2>
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            <div class="card-body">
                                <h3 class="card-title" id="card2_title">Protéines (g/100 g)</h3>
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            <div class="card-body">
                                <h3 class="card-title" id="card3_title">Glucides (g/100 g)</h3>
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            <div class="card-body">
                                <h3 class="card-title" id="card4_title">Lipides (g/100 g)</h3>
